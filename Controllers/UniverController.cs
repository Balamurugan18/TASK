...
namespace Task.Controllers
{
    public class UniverController : Controller
    {
                   ...
                   for (int i = 0; i < dtEarly.Rows.Count; i++)
                    {
                        if (i == 0)
                        {
                            ...
                            uni.Domestic_Earlr_Notification1 = dtEarly.Rows[i]["Earlr_Notification"].ToString();
                            uni.Domestic_Early_Decision_Deadline1 = dtEarly.Rows[i]["Early_Decision_Deadline"].ToString();
                            uni.Domestic_Early_Deposit_Deadline1 = dtEarly.Rows[i]["Early_Deposit_Deadline"].ToString();
                        ...
                        else
                        {
                            ...
                            uni.International_Earlr_Notification1 = dtEarly.Rows[i]["Earlr_Notification"].ToString();
                            uni.International_Early_Decision_Deadline1 = dtEarly.Rows[i]["Early_Decision_Deadline"].ToString();
                            uni.International_Early_Deposit_Deadline1 = dtEarly.Rows[i]["Early_Deposit_Deadline"].ToString();
                ...
                if (dtSpring_Priority.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtSpring_Priority.Rows.Count; i++)
                    {
                        if (i == 0)
                        {
                            ...
                            uni.Domestic_Spring_Priority_Decision_Deadline1 = dtSpring_Priority.Rows[i]["Decision_Deadline"].ToString();
                            uni.Domestic_Spring_Priority_Decision_Notification1 = dtSpring_Priority.Rows[i]["Decision_Notification"].ToString();
                            uni.Domestic_Spring_Priority_Deposit_Deadline1 = dtSpring_Priority.Rows[i]["Deposit_Deadline"].ToString();
                        ...
                        else
                        {
                            ...
                            uni.International_Spring_Priority_Decision_Deadline1 = dtSpring_Priority.Rows[i]["Decision_Deadline"].ToString();
                            uni.International_Spring_Priority_Decision_Notification1 = dtSpring_Priority.Rows[i]["Decision_Notification"].ToString();
                            uni.International_Spring_Priority_Deposit_Deadline1 = dtSpring_Priority.Rows[i]["Deposit_Deadline"].ToString();
                ...
                if (dtSummer_Priority.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtSummer_Priority.Rows.Count; i++)
                    {
                        if (i == 0)
                        {
                            ...
                            uni.Domestic_Summer_Priority_Decision_Deadline1 = dtSummer_Priority.Rows[i]["Decision_Deadline"].ToString();
                            uni.Domestic_Summer_Priority_Decision_Notification1 = dtSummer_Priority.Rows[i]["Decision_Notification"].ToString();
                            uni.Domestic_Summer_Priority_Deposit_Deadline1 = dtSummer_Priority.Rows[i]["Deposit_Deadline"].ToString();
                        ...
                        else
                        {
                            ...
                            uni.International_Summer_Priority_Decision_Deadline1 = dtSummer_Priority.Rows[i]["Decision_Deadline"].ToString();
                            uni.International_Summer_Priority_Decision_Notification1 = dtSummer_Priority.Rows[i]["Decision_Notification"].ToString();
                            uni.International_Summer_Priority_Deposit_Deadline1 = dtSummer_Priority.Rows[i]["Deposit_Deadline"].ToString();
        ...
        public ActionResult View(string Name,Univer uni1,string Save)
        {
           ...
           new object[] { User_id, na1[1], 2, uni1.International_Summer_Priority_Decision_Offered,
            ...
            if (HttpContext.Session["User"] != null)
            {
                ...
                else if (Save == "Early_Update")
                {
                    ...
                    if (uni1.Domestic_Earlr_Notification1 == null)
                    {
                        uni1.Domestic_Earlr_Notification1 = "";
                    }
                    if (uni1.Domestic_Early_Decision_Deadline1 == null)
                    {
                        uni1.Domestic_Early_Decision_Deadline1 = "";
                    }
                    if (uni1.Domestic_Early_Deposit_Deadline1 == null)
                    {
                        uni1.Domestic_Early_Deposit_Deadline1= "";
                    }
                    if (uni1.Domestic_Early_Financial_Aid_Deadline == null)
                    {
                        uni1.Domestic_Early_Financial_Aid_Deadline = "";
                    ...
                    int id = Convert.ToInt32(DBWizard.ExecuteScalar(strConnString, "Sp_Update_Early_Admission",
                      new object[] { User_id, na1[1], 1, uni1.Domestic_Early_Decision_Offered,uni1.Domestic_Earlr_Notification1,
                        uni1.Domestic_Early_Decision_Deadline1,uni1.Domestic_Early_Deposit_Deadline1,
                        uni1.Domestic_Early_Financial_Aid_Deadline,uni1.Domestic_Early_Action_offered,
                        uni1.Domestic_Early_Action_Deadline,
                       uni1.Domestic_Early_Action_Notification,uni1.Domestic_Early_Notes,uni1.Domestic_Early_Data_URL}));
                    ...
                    if (uni1.International_Earlr_Notification1 == null)
                    {
                        uni1.International_Earlr_Notification1 = "";
                    }
                    if (uni1.International_Early_Decision_Deadline1 == null)
                    {
                        uni1.International_Early_Decision_Deadline1 = "";
                    }
                    if (uni1.International_Early_Deposit_Deadline1 == null)
                    {
                        uni1.International_Early_Deposit_Deadline1 = "";
                    }
                    if (uni1.International_Early_Financial_Aid_Deadline == null)
                    {
                        uni1.International_Early_Financial_Aid_Deadline = "";
                    ...
                    id = Convert.ToInt32(DBWizard.ExecuteScalar(strConnString, "Sp_Update_Early_Admission",
                     new object[] { User_id, na1[1], 2, uni1.International_Early_Decision_Offered,
                      uni1.International_Earlr_Notification1,
                        uni1.International_Early_Decision_Deadline1,uni1.International_Early_Deposit_Deadline1,
                        uni1.International_Early_Financial_Aid_Deadline,uni1.International_Early_Action_offered,
                        uni1.International_Early_Action_Deadline,
                       uni1.International_Early_Action_Notification,uni1.International_Early_Notes,
                       uni1.International_Early_Data_URL}));
                ...
                else if (Save == "Spring_Priority_Update")
                {
                    ...
                    if (uni1.Domestic_Spring_Priority_Decision_Deadline1 == null)
                    {
                        uni1.Domestic_Spring_Priority_Decision_Deadline1 = "";
                    }
                    if (uni1.Domestic_Spring_Priority_Decision_Notification1 == null)
                    {
                        uni1.Domestic_Spring_Priority_Decision_Notification1 = "";
                    }
                    if (uni1.Domestic_Spring_Priority_Deposit_Deadline1 == null)
                    {
                        uni1.Domestic_Spring_Priority_Deposit_Deadline1 = "";
                    }
                    if (uni1.Domestic_ESpring_Priority_Financial_Aid_Deadline == null)
                    {
                        uni1.Domestic_ESpring_Priority_Financial_Aid_Deadline = "";
                ...
                new object[] { User_id, na1[1], 1, uni1.Domestic_Spring_Priority_Decision_Offered,
                uni1.Domestic_Spring_Priority_Decision_Deadline1,uni1.Domestic_Spring_Priority_Decision_Notification1,
                 uni1.Domestic_Spring_Priority_Deposit_Deadline1,uni1.Domestic_ESpring_Priority_Financial_Aid_Deadline,
                 uni1.Domestic_ESpring_Priority_Notes,uni1.Domestic_ESpring_Priority_Data_URL, }));
                    ...
                    if (uni1.International_Spring_Priority_Decision_Deadline1 == null)
                    {
                        uni1.International_Spring_Priority_Decision_Deadline1 = "";
                    }
                    if (uni1.International_Spring_Priority_Decision_Notification1 == null)
                    {
                        uni1.International_Spring_Priority_Decision_Notification1 = "";
                    }
                    if (uni1.International_Spring_Priority_Deposit_Deadline1 == null)
                    {
                        uni1.International_Spring_Priority_Deposit_Deadline1 = "";
                    }
                    if (uni1.International_ESpring_Priority_Financial_Aid_Deadline == null)
                    {
                        uni1.International_ESpring_Priority_Financial_Aid_Deadline = "";
               ...
               new object[] { User_id, na1[1], 2, uni1.International_Spring_Priority_Decision_Offered,
                uni1.International_Spring_Priority_Decision_Deadline1,uni1.International_Spring_Priority_Decision_Notification1,
                 uni1.International_Spring_Priority_Deposit_Deadline1,uni1.International_ESpring_Priority_Financial_Aid_Deadline,
                 uni1.International_ESpring_Priority_Notes,uni1.International_ESpring_Priority_Data_URL, }));
                ...
                else if (Save == "Summer_Priority_Update")
            {
                ...
                if (uni1.Domestic_Summer_Priority_Decision_Deadline1 == null)
                {
                    uni1.Domestic_Summer_Priority_Decision_Deadline1 = "";
                }
                if (uni1.Domestic_Summer_Priority_Decision_Notification1 == null)
                {
                    uni1.Domestic_Summer_Priority_Decision_Notification1 = "";
                }
                if (uni1.Domestic_Summer_Priority_Deposit_Deadline1 == null)
                {
                    uni1.Domestic_Summer_Priority_Deposit_Deadline1 = "";
                }
                if (uni1.Domestic_ESummer_Priority_Financial_Aid_Deadline == null)
                {
                    uni1.Domestic_ESummer_Priority_Financial_Aid_Deadline = "";
            ...
            new object[] { User_id, na1[1], 1, uni1.Domestic_Summer_Priority_Decision_Offered,
                uni1.Domestic_Summer_Priority_Decision_Deadline1,uni1.Domestic_Summer_Priority_Decision_Notification1,
                 uni1.Domestic_Summer_Priority_Deposit_Deadline1,uni1.Domestic_ESummer_Priority_Financial_Aid_Deadline,
                 uni1.Domestic_ESummer_Priority_Notes,uni1.Domestic_ESummer_Priority_Data_URL, }));
                ...
                if (uni1.International_Summer_Priority_Decision_Deadline1 == null)
                {
                    uni1.International_Summer_Priority_Decision_Deadline1 = "";
                }
                if (uni1.International_Summer_Priority_Decision_Notification1 == null)
                {
                    uni1.International_Summer_Priority_Decision_Notification1 = "";
                }
                if (uni1.International_Summer_Priority_Deposit_Deadline1 == null)
                {
                    uni1.International_Summer_Priority_Deposit_Deadline1 = "";
                }
                if (uni1.International_ESummer_Priority_Financial_Aid_Deadline == null)
                {
                    uni1.International_ESummer_Priority_Financial_Aid_Deadline = "";
           ...
           new object[] { User_id, na1[1], 2, uni1.International_Summer_Priority_Decision_Offered,
                uni1.International_Summer_Priority_Decision_Deadline1,uni1.International_Summer_Priority_Decision_Notification1,
                 uni1.International_Summer_Priority_Deposit_Deadline1,uni1.International_ESummer_Priority_Financial_Aid_Deadline,
                 uni1.International_ESummer_Priority_Notes,uni1.International_ESummer_Priority_Data_URL, }));
                ...
                if (dtSpring_Priority.Rows.Count > 0)
                {
                    if (Save == "Spring_Priority_Update")
                    {
                ...
                if (dtSummer_Priority.Rows.Count > 0)
                {
                    if (Save == "Summer_Priority_Update")
                    {
